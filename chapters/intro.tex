...
Audio classification plays a crucial role in contemporary \gls{aad} systems by providing {essential insights}\label{rev:ru_min_1a} suitable for various applications~\citep{Kilickaya2025, LoScudo2023, Barusco2025}. These fields are valid not only for industrial environments~\citep{Purohit2019} but also for dynamic urban areas~\citep{Piczak2015, Salamon2014} and even complex natural ecosystems, such as forests~\citep{Bandara2023}. \dots
