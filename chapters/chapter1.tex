...
The utilization of acoustic methods in the context of environmental surveillance or the identification of irregularities, as illustrated in Figure~\ref{fig:audio_based}, boasts a substantial historical precedent~\citep{Simonovic2021, Vicuna2017}. In general, abnormal conditions that occur at the measuring device or location can be detected by \dots
...
\begin{table}[!ht]
	...
	\begin{tabular}{p{0.3\linewidth}ccp{0.4\linewidth}}
		...
		\midrule
		\citet{Shaikh2021} & \gls{tlr} & 44 & Exploring the potential of acoustic signal analysis in facilitating machine fault diagnosis.\\
		\hline
		\citet{Qurthobi2022}& \gls{slr} & 52 & \Gls{sota} mechanical failure detection using acoustic methods.\\
		\hline
		\dots& \dots & \dots & \dots\\
		\bottomrule
	\end{tabular}
