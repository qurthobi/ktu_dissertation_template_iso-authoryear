...
\begin{table}[!ht]
	\centering
	% \footnotesize
	\caption[Garso failų pasiskirstymas MIMII duomenų rinkinyje]{Garso failų pasiskirstymas \gls{mimii} duomenų rinkinyje~\citep{Purohit2019}}
...
\begin{table}[!ht]
	\centering
	\caption[Bendrosios MIMII duomenų rinkinio savybės]{Bendrosios \gls{mimii} duomenų rinkinio savybės~\citep{Purohit2019}}
